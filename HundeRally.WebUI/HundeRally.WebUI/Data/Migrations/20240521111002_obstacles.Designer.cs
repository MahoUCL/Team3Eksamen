...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HundeRally.WebUI.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("WebUI.Domain.Entity.Obstacle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("DifficultyNameId")
                        .HasColumnType("int");

                    b.Property<int>("Diffucltyid")
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ObstacleImgUrl")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("obstacle_img_url");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HundeRally.WebUI.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebUI.Domain.Entity.Obstacle", b =>
                {
                    b.HasOne("WebUI.Domain.Entity.ObstacleDifficulty", "DifficultyName")
                        .WithMany("Obstacles")
                        .HasForeignKey("DifficultyNameId");
